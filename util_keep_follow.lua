...
FloorChangers = {
  Ladders = {
      Up = {1948, 5542, 16693, 16692, 8065, 8263, 1968},
  ...
  Stairs = {
      Up = {16690, 1958, 7548, 7544, 1952, 1950, 1947, 7542, 855, 856, 1978, 1977, 6911, 6915, 1954, 5259, 20492, 1956, 5257, 5258, 775, 25058, 22566, 22747, 30757, 20225, 8657, 6913, 1964},
      Down = {482, 414, 413, 437, 7731, 469, 413, 434, 859, 438, 6127, 566, 7476, 4826, 484, 433, 369, 20259, 19960, 411, 8932, 7768, 6130, 601, 6913, 604}
  },
...
macro(100, "Keep Follow", "", function(macro)
    ...
    checkTargetPos()
    if creatureId ~= 0 and target ~= "" and targetMissing() and lastKnownPosition then
        handleFloorChange()
        say(creature)
    end
